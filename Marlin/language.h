...
#define MSG_INVALID_SENSOR_STATE            "Invalid Filament Sensor State. Use 0 for off or 1 for on"
#define MSG_INVALID_SENSOR_NORMAL           "Invalid Filament Sensor Normal State. Use 0 for Normally Closed or 1 for Normally Open"
